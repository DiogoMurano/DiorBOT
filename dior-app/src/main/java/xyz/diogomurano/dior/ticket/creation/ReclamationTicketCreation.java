...
public class ReclamationTicketCreation implements TicketCreation{
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    embedBuilder.setTitle("Reclamação - Etapa #1");
                    embedBuilder.setColor(color);
                    embedBuilder.setDescription("**Qual a sua reclamação?**");
                    embedBuilder.addField("Instrução:", "Seja o mais detalhado possível para que o feedback" +
                            " possa ser mais preciso.", false);
                });
            }
            ...
            public void validateMessage(Message message) {
                channel.sendMessage(DiscordAPI.createEmbed(embedBuilder -> {
                    embedBuilder.setColor(color);
                    embedBuilder.setTitle("Reclamação registrada");
