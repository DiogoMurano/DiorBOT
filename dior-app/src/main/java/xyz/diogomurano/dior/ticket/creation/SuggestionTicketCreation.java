...
public class SuggestionTicketCreation implements TicketCreation {
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    embedBuilder.setTitle("Sugestão - Etapa #1");
                    embedBuilder.setColor(color);
                    embedBuilder.setDescription("**Qual a sua sugestão?**");
            ...
            public void validateMessage(Message message) {
                channel.sendMessage(DiscordAPI.createEmbed(embedBuilder -> {
                    embedBuilder.setColor(color);
                    embedBuilder.setTitle("Sugestão registrada");
