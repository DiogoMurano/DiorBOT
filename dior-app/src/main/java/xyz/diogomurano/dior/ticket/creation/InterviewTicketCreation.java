...
public class InterviewTicketCreation implements TicketCreation {
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    ...
                    embedBuilder.setColor(color);
                    embedBuilder.setDescription("**As informações sobre o novo cargo ficaram claras?**");
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    ...
                    embedBuilder.setColor(color);
                    embedBuilder.setDescription("**Você gostava da sua função anterior?**");
                    embedBuilder.addField("Instrução:", "Copie a mensagem e envie ao colaborador. Registre a resposta aqui.", false);
                });
            }
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    ...
                    embedBuilder.setColor(color);
                    embedBuilder.setDescription("**Gostaria de fazer um elogio a respeito da promoção? Se sim, qual?**");
                    embedBuilder.addField("Instrução:", "Copie a mensagem e envie ao colaborador. Registre a resposta aqui.", false);
                });
            }
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    ...
                    embedBuilder.setColor(color);
                    embedBuilder.setDescription("**Gostaria de fazer uma reclamação a respeito da promoção? Se sim, qual?**");
                    embedBuilder.addField("Instrução:", "Copie a mensagem e envie ao colaborador. Registre a resposta aqui.", false);
                });
            }
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    ...
                    embedBuilder.setColor(color);
                    embedBuilder.setDescription("**Deseja acrescentar algo mais?**");
                    embedBuilder.addField("Instrução:", "Copie a mensagem e envie ao colaborador. Registre a resposta aqui.", false);
                });
            }
        ...
        process.add(new Step() {
            ...
            public MessageEmbed getMessage() {
                return DiscordAPI.createEmbed(embedBuilder -> {
                    ...
                    embedBuilder.addField("As informações sobre o novo cargo ficaram claras?", metadata.get("step1"), false);
                    embedBuilder.addField("Você gostava da sua função anterior?", metadata.get("step2"), false);
                    embedBuilder.addField("Gostaria de fazer um elogio a respeito da promoção? Se sim, qual?", metadata.get("step3"), false);
                    embedBuilder.addField("Gostaria de fazer uma reclamação a respeito da promoção? Se sim, qual?", metadata.get("step4"), false);
                    embedBuilder.addField("Deseja acrescentar algo mais?", metadata.get("step5"), false);
                });
            }
            ...
            public void validateReaction(MessageReaction reaction) {
                ...
                if (emoji.equalsIgnoreCase("U+2705")) {
                    ...
                    HabboUser user = metadata.get("user");
                    jda.getTextChannelById("710815417370935366").sendMessage(DiscordAPI.createEmbed(embedBuilder -> {
